...
const Register = () => {
    const { userCreateRegister } = useContext(AuthContext)
    const handleRegister = (event) => {
        ...
        userCreateRegister(email, password)
            .then(result => {
            ...
            <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md  md:h-[90%] md:w-[80%] lg:h-[80%]">
                ...
                <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%]">
                    ...
                    <div className="mx-auto flex h-[50px] w-[200px] items-center overflow-hidden rounded-full shadow-md duration-300 hover:scale-95 hover:shadow">
                        <div className="flex h-full w-[50%] items-center bg-[#9deb8c] pl-4 text-sm text-white">Sign With</div>
                        ...
                        <span className="pr-4 text-4xl font-bold text-[#050505]">G+</span>
                    </div>
                </div>
            </div>
        </div>
