...
export const CarouselMain = () => {
    ...
    const sliders = [{img: "https://i.ibb.co/G08yfWV/rose-320868-1280.jpg/600x600/?bedrooms", tags: "Room",}, {img: "https://i.ibb.co/RSV4LMS/woman-3946473-1280.jpg/600x600/?room", tags: "Room",}, {img: "https://i.ibb.co/c3DB2qH/woman-531252-1280.jpg/600x600/?livingrooms", tags: "Room",}, {img: "https://source.unsplash.com/600x600/?livingroom", tags: "Room",}, {img: "https://source.unsplash.com/600x600/?bedrooms", tags: "Room",},];
...
export const Carosel = () => {
    return (
        ...
        <div className="w-2/3 lg:w-1/3 text-center lg:text-left space-y-2 lg:space-y-5 py-5">
            <h1 className="text-xl md:text-2xl lg:text-[40px] font-bold">50+ Beautiful rooms inspiration</h1>
            <p className="text-[#616161] text-1xl md:text-lg">Our designer already made a lot of beautiful prototipe of rooms that inspire you</p>
